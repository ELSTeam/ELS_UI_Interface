...
const AboutUs = (props) => {
  ...
  return (
    ...
    <div className="about-us">
      ...
      <p className="about-text">For more information about our project, please visit our <a href="https://github.com/ELSTeam" target="_blank" rel="noopener noreferrer">GitHub repository</a>.</p>
      <p className='LAST-P'>Thank you for your attention! ELS Team</p>
      <div className="footer">
        <p className="BackToLobbyFromAbout">
