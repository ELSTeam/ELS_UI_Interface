    ...
    return (
        <div className='main-div'>
            <div style={{ display: "flex", display: "inline-block", float: "center" }}>
                <p className='els-header' style={{fontFamily:'Trebuchet MS', fontSize:"660%"}}>ELS</p>
                <div className='els-sentence' style={{marginTop:"-65%"}}>Elderly Life Server</div>
                </div>
            <div className='four-squares' style={{ float: "center" }}>
            <div>
            <button className='square' style={{ width: "23%" }} >
                <div>
